...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="py-20 md:py-28 bg-gradient-to-b from-secondary/30 to-background relative overflow-hidden" ref={ref}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative bg-card rounded-2xl p-8 shadow-sm hover:shadow-2xl hover:shadow-accent/10 border border-border/50 hover:border-accent/50 transition-all duration-500 overflow-hidden"
            >
